...
INSERT INTO `bookedseat` (`id`, `user_id`, `bus_id`, `seat_location`, `seat_no`, `fare`, `pnr_no`, `travel_date`, `datetime`, `book_status`) VALUES
(2, 1, 3, '1_4,2_5', '3,8', '815', '1331011483', '0000-00-00', '0000-00-00 00:00:00', '1'),
(3, 1, 8, '2_2,2_4,2_5', '6,7,8', '730', '1206468481', '18:40:00', '0000-00-00 00:00:00', '1'),
(4, 1, 8, '1_5,2_5', '4,8', '730', '1210345909', '18:40:00', '2016-02-27 14:18:03', '1'),
(5, 1, 3, '2_1,2_2,3_2', '5,6,10', '815', '1329360155', '15:45:00', '2016-02-27 14:20:25', '1'),
(6, 1, 8, '2_4,1_5', '7,4', '730', '1236675930', '18:40:00', '2016-02-27 14:24:29', '1'),
(7, 1, 8, '2_4,2_5', '7,8', '730', '1405978142', '02/29/2016', '2016-02-27 14:28:57', '1'),
(8, 1, 2, '2_5,2_4,3_4,4_4', '8,7,11,15', '400', '1374210598', '02/29/2016', '2016-02-27 18:04:18', '1');
...
INSERT INTO `busseats` (`seat_id`, `bus_id`, `seatno`, `price`, `status`) VALUES
(1, 1, 3, 360, 1);
...
ALTER TABLE `busseats`
  ADD CONSTRAINT `busseats_ibfk_1` FOREIGN KEY (`bus_id`) REFERENCES `bus` (`bus_id`);
